...
public class Directory {
	...
	public ArrayList<VFS_Visitor.File> files;
	public ArrayList<VFS_Visitor.Directory> subDirectories;
	...
	public void fromJson(JSONObject ob) throws JSONException {
		...
		for (int i = 0; i < fileSize; i++) {
			...
			VFS_Visitor.File file = new File(obb.getString("name"),
		...
		for (int i = 0; i < folderSize; i++) {
			VFS_Visitor.Directory directory = new Directory("", "");
