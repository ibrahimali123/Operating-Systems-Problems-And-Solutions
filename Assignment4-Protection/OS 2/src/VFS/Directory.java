...
public class Directory {
	...
	void print(String path){
		System.out.println(isContainDic(path));
	}
	...
	public boolean isContainDic(String path) {
		...
		//System.out.println(subPath + "  " + name);
		
		for (int i = 0; i < subDirectories.size(); i++) {
			if (subDirectories.get(i).Name.equals(name)) {
				return subDirectories.get(i).isContainDic(subPath);
			}
		}
